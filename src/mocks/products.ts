...
import KryptonOne from "@/assets/images/krypton-one.png";
...
export const products = [
  ...
  },
  {
    ...
    image: KryptonOne,
    price: 160,
    color: "White/Black/Electric blue",
    description:
      "Tênis casual de cano baixo inspirado no estilo streetwear e no universo do basquete clássico. Seu design combina um cabedal em branco com sobreposições pretas e detalhes em azul elétrico, resultando em uma aparência moderna, esportiva e elegante.",
