  ...
  return (
    <section className="flex flex-col md:flex-row items-center md:h-screen">
      ...
      <div className="text-black px-8 py-16 lg:px-20 md:w-1/2 h-full flex flex-col justify-center">
        <h2 className="text-5xl lg:text-6xl font-medium text-[#333] mb-8">
          Sobre nós
        </h2>
        <p className="text-[#777] text-lg leading-relaxed mb-5">
        ...
        <Link
          to="/our-stores"
          className="self-start inline-block text-xs font-bold 
        text-[#333] uppercase border-b-2 tracking-[2.5px] hover:text-accent transition-colors
        duration-500"
        >
